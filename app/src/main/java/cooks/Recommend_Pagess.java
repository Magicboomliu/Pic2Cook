...
public class Recommend_Pagess extends Fragment {
    ...
    private List<String> detailed_urlist;
     ...
     private Handler handler = new Handler(){
       ...
       {
           switch(msg.what){
               case Loaded_information_is_OK:
                   reommend_rv_adatpter adatpter2 = new reommend_rv_adatpter(getContext(),rras);
                   recyclerView.setAdapter(adatpter2);
                   pg1.dismiss();
                   break;
               case No_result:
                   init_first();
                   reommend_rv_adatpter adatpter3 = new reommend_rv_adatpter(getContext(),rras);
                   recyclerView.setAdapter(adatpter3);
                   AlertDialog.Builder dialog  = new AlertDialog.Builder(getContext());
                   dialog.setTitle("抱歉，Pic2Cook未能找到相关搭配");
                   dialog.setMessage("您的搜索要求过于奇特，Pic2Cook目前还没有呢~，要不然您开发一下这个菜品吧。");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =inflater.inflate(R.layout.test_recommend,container,false);

        Filtessr = view.findViewById(R.id.filter_button_of_recomend2);

        quit_remmend = view.findViewById(R.id.quit_recommend);
        quit_remmend.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        hints = view.findViewById(R.id.recognition_label);
        ...
        recyclerView = view.findViewById(R.id.recy_view_of_recommend);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        init_first();
        reommend_rv_adatpter adatpter = new reommend_rv_adatpter(getContext(),rras);
        recyclerView.setAdapter(adatpter);

        refreshLayout =view.findViewById(R.id.refreshLayout_recomm);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        hints.setText(pushContents);

        new Thread(new Runnable(){
            @Override
            public void run() {

                String chinese =convertChineseWords_to_BYTES(pushContents);
                ...
                try {
                    ...
                    Elements somthing= doc.select("div.pic").select("a");
                    ...
                    try {
                        ...
                        for(int j=0;j<Nums_of_searched;j++)
                        {
                         ...
                         detailed_urlist.add(somthing.get(j).attr("href"));
                        ...
                        message.what =Loaded_information_is_OK;
...
//        Log.d("Result","Here Comes the 便利结果");
        ...
        drawerLayout3 =view.findViewById(R.id.drawer_layout_rem);

        NavigationView navigationView = view.findViewById(R.id.naV_viewRM);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getTitle().equals("按照耗费的时间排序"))
                {
                    ...
                    reommend_rv_adatpter adapterww = new reommend_rv_adatpter(getContext(),scc_new);
